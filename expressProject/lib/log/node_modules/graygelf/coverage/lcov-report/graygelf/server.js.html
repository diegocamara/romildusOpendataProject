...
<html lang="en">
<head>
    <title>Code coverage report for graygelf/server.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">graygelf/server.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">graygelf/</a> &#187; server.js</div>
</div>
<div class="body">
...
&nbsp;
  switch (buf[0]) {
    ...
    case 0x1e: // chunked message
      ...
      break
<span class="branch-3 cbranch-no" title="branch not covered" >    default: </span>  // unknown message
  }
}
&nbsp;
GrayGelfServer.prototype._broadcast = function (er, buf) {
  /* istanbul ignore next */
  <span class="skip-if-branch" title="if path not taken" >I</span>if (er) <span class="cstat-skip" title="statement not covered" >return this.emit('error', er)</span>
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Sep 30 2014 16:14:08 GMT-0500 (CDT)</div>
</div>
